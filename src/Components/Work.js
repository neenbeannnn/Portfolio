            ...
            <Fragment>
                ...
                <div className='work-body'>
                    <div className='work-container'>
                        <div className='featured-work' onMouseEnter={() => this.setState({ workOneHover: true })} onMouseLeave={() => this.setState({ workOneHover: false })}>
                            ...
                            <Row>
                                ...
                                <Col xs={12} xl={8}>
                                    ...
                                    <div className='mt-2 mb-5 work-info'>
                        ...
                        <Row>
                            <Col xs={12} lg={6} className='work-one' onMouseEnter={() => this.setState({ workTwoHover: true })} onMouseLeave={() => this.setState({ workTwoHover: false })}>
                                <div className='date-stamp p-2'>
                                    2014 - Current
                            </div>
                                <h3 className='work-title'>
                                ...
                                <div className='work-info mb-5'>
                                    I work at <span className='emphasize-text'>Deerfield & University Park</span>, where I lead and assist with <span className='emphasize-text'>art and recreation</span> classes for children ages 3-10.
                            ...
                            <Col xs={12} lg={6} className='work-two' onMouseEnter={() => this.setState({ workThreeHover: true })} onMouseLeave={() => this.setState({ workThreeHover: false })}>
